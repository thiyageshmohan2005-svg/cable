...
(async () => {
  ...
  if (env.db.password) {
    connectionConfig.password = env.db.password;
  }
...
CREATE TABLE IF NOT EXISTS monthly_bills (
    ...
    PRIMARY KEY (bill_id),
    FOREIGN KEY (customer_id) REFERENCES customers(customer_id) ON DELETE CASCADE ON UPDATE CASCADE,
    UNIQUE KEY uq_monthly_bills_customer_period (customer_id, billing_month, billing_year),
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    FOREIGN KEY (bill_id) REFERENCES monthly_bills(bill_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
`;
    ...
    console.log('Database schema imported successfully into', env.db.database);
  } catch (error) {
